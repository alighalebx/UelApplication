...
public partial class ArtificialIntelligencePageView : UserControl
{
    public ObservableCollection<Section> Sections { get; } = new ObservableCollection<Section>();
    public ArtificialIntelligencePageView()
    {
        InitializeComponent();
        DataContext = new ArtificialIntelligencePageViewModel(); // Ensure this is set

    }
    private void AddSectionButton_Click(object sender, RoutedEventArgs e)
    {
        var viewModel = DataContext as ArtificialIntelligencePageViewModel;
