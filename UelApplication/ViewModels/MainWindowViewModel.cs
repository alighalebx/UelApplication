...
public partial class MainWindowViewModel : ViewModelBase
{
    ...
    public ObservableCollection<ListItemTemplate> Items { get; } = new()
    {
        ...
        new ListItemTemplate(typeof(SoftwarePageViewModel), "Software"),
        new ListItemTemplate(typeof(ArtificialIntelligencePageViewModel), "ArtificialIntelligence"),
        new ListItemTemplate(typeof(DigitalMultiMediaPageViewModel), "GamesRegular"),
        new ListItemTemplate(typeof(CyberSecurityPageViewModel), "Cybersecurity"),
    };
